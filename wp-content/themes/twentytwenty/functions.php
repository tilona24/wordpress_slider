...
require get_template_directory().'/inc/the-amazing-sliderman.php';
...
{
    echo '<a class="skip-link screen-reader-text" href="#site-content">'.__(
            'Skip to the content',
            'twentytwenty'
        ).'</a>';
}
...
function twentytwenty_block_editor_styles()
{
    ...
    wp_enqueue_script(
        'twentytwenty-block-editor-script',
...
function twentytwenty_customize_controls_enqueue_scripts()
{
    ...
    wp_enqueue_script(
        'twentytwenty-customize-controls',
        get_template_directory_uri().'/assets/js/customize-controls.js',
        ['twentytwenty-color-calculations', 'customize-controls', 'underscore', 'jquery'],
        $theme_version,
        false
    );
    wp_localize_script(
        'twentytwenty-customize-controls',
        'twentyTwentyBgColors',
